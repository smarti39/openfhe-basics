...
Ciphertext<DCRTPoly> matrixMultiply(CryptoContext<DCRTPoly> cc, std::vector<Ciphertext<DCRTPoly>> conc_matrix, Ciphertext<DCRTPoly> query, PublicKey<DCRTPoly> pk);
